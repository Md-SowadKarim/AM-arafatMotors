...
const OrderDetails = () => {
  ...
  return (
    ...
    <div className='md:flex'>
        ...
        <div className='border-2 border-black text-center mt-2 md:w-[30%] flex justify-center items-center'>qr code</div>
        </div>
    ...
    <img class="object-cover w-full rounded-t-lg h-auto md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={oneprofile.image} alt=""/>
