...
const columns = [
          ...
          <div className='p-1 '>
           <div className="flex items-center">
                ...
                <img className="object-cover mx-auto w-20 rounded-xl border-black border-2" src={row.image} alt="Avatar"/>
                    <a href="#" className="mx-2 font-semibold text-black" tabindex="0" role="link">{row.title}</a>
                   </div>
    ...
    },
    {
        ...
        <h1 className='text-black '>Duration : {row.duration}</h1>
        </div>
      
        <div className='flex gap-2  items-center'>
            <h1 className='text-black '> CourseId : {row.cid}  😊</h1>
            </div>
        <div className='flex gap-2  items-center'>
            <h1 className='text-black '> Lesson {row.lesson}  😊</h1>
            </div>
...
<dialog id={row._id} className="modal modal-bottom sm:modal-middle">
  <div className="modal-box p-4 border-2 border-black">
    ...
    <p className="py-4 text-xl text-red-400 "> delete this ? ✂✂</p>
...
<div className='container mx-auto space-y-3 p-5 rounded-lg text-center'>
     <h1 className= '  font-extrabold font-poppins text-2xl'>This Is Manage My Courses  Page</h1>
