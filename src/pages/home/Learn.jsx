      ...
      <span className="relative flex justify-center mb-9 ">
        ...
        <div>
            <div className='md:flex justify-between gap-2'>
               ...
               <div className='flex-1 hover:bg-blue-500 hover:text-white md:border-4 md:border-red-500 p-1 rounded-xl h-auto py-4 '>

               
                <div  className='flex-1 hover:bg-blue-500 hover:text-white border-4 border-red-500 p-1 rounded-xl h-auto py-4'><h1 className='font-bold text-center'>
