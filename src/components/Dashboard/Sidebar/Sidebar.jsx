...
const Sidebar = () => {
 ...
 const handleToggle = () => {
  ...
  return (
    <>
      {/* Small Screen Navbar */}
      <div className='bg-gray-100 text-black sticky top-0 z-10   dark:text-white dark:bg-blue-950 flex justify-between md:hidden'>
        <div>
      ...
      {/* Sidebar */}
      <div
        className={`z-10 md:fixed flex flex-col justify-between fixed top-0 overflow-x-hidden bg-blue-500 w-64 space-y-6 px-2 py-4  inset-y-0 left-0 transform ${
